...
public class WristCommandDirectAxes extends Command {
   ...
   */
  public WristCommandDirectAxes(Wrist subsystem, int PIDPositionIndex) {
  ...
  public void initialize() {
    ...
    wristAnglesArray[4] = WristConstants.PRESETS.Climb;
    wristAnglesArray[5] = WristConstants.PRESETS.INTAKE;
    wristAnglesArray[6] = WristConstants.PRESETS.GROUND;
    wristAnglesArray[7] = WristConstants.PRESETS.INTERMEDIATE;
    m_subsystem.setAxesVector(wristAnglesArray[m_PIDPositionIndex]);
  }
